...
const Menus = ({ siderFold, darkTheme, navOpenKeys, changeOpenKeys, location, permissionList, dispatch }) => {
  ...
  const menu = permissionList
  // 生成树状
  const menuTree = arrayToTree(menu.filter(_ => _.is_menu === 1), 'id', 'fid')
  const levelMap = {}
  // 递归生成菜单
